...
def getGloveEmbeddings(glovefolderpath):
    print("---------------------- Getting Glove Embeddings -------------------------/n")
    embeddings_dictionary = dict()
    glove_file = open(f"C:/Users/USER/OneDrive/Desktop/deeplearning/deep-learning/LSTM/CustomLSTM/glove.6B.100d.txt", encoding="utf8")
...
dataset =  pd.read_csv('https://raw.githubusercontent.com/adityaiiitmk/Datasets/master/movie_data.csv')
print("----------------------  -------------------------\n")
...
def plot_confusion_matrix(y_true, y_pred):
   ...
   plt.savefig('C:/Users/USER/OneDrive/Desktop/deeplearning/deep-learning/GRU/results/results.jpg')
